...
author: "Martínez Casimiro Nestor Hugo"
date: "2024-02-24"
output: pdf_document
---
...
The last chunk of code isn't executed since it cannot be displayed by LATEX due to some encoding issues that will be handled later. However i add an image of the actual input:  

![Emoji list](Screenshot 2024-02-24 234316.png)